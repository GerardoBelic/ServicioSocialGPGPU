...
int main(int argc, char **argv)
{
	...
	for (unsigned iter = 0; iter < numIterations; ++iter)
	{
        ...
        checkCudaErrors(cudaLaunchKernel((void *)n_body_vel_calc, dimGrid, dimBlock, kernelArgs, 0, 0));
        checkCudaErrors(cudaLaunchKernel((void *)n_body_pos_calc, dimGrid, dimBlock, kernelArgs_2, 0, 0));
		/*{
